...
var defaultInternalTranslator = &internalTranslator{
	...
	Messages: map[string]map[string]string{
		...
		msgStringValidJson: {
			"en": msgStringValidJson,
			"fr": "La valeur de la chaîne doit être un JSON valide",
			"es": "El valor de cadena debe ser JSON válido",
			"it": "Il valore della stringa deve essere JSON valido",
			"de": "Zeichenfolgenwert muss gültiges JSON sein",
		},
		msgStringLowercase: {
		...
		msgValidCountryCode: {
			"en": msgValidCountryCode,
			"fr": "La valeur doit être un code de pays ISO-3166 valide",
			"es": "El valor debe ser un código de país ISO-3166 válido",
			"it": "Il valore deve essere un codice paese ISO-3166 valido",
			"de": "Wert muss ein gültiger ISO-3166-Ländercode sein",
		},
		msgValidCurrencyCode: {
			"en": msgValidCurrencyCode,
			"fr": "La valeur doit être un code de devise ISO-4217 valide",
			"es": "El valor debe ser un código de moneda ISO-4217 válido",
			"it": "Il valore deve essere un codice valuta ISO-4217 valido",
			"de": "Wert muss ein gültiger ISO-4217-Währungscode sein",
		},
		msgValidEmail: {
			"en": msgValidEmail,
		...
		msgValidLanguageCode: {
			"en": msgValidLanguageCode,
			"fr": "La valeur doit être un code de langue valide",
			"es": "El valor debe ser un código de idioma válido",
			"it": "Il valore deve essere un codice lingua valido",
			"de": "Wert muss ein gültiger Sprachcode sein",
		},
		msgValidISODate: {
			"en": msgValidISODate,
		...
		msgValidTimezone: {
			"en": msgValidTimezone,
			"fr": "La valeur doit être un fuseau horaire valide",
			"es": "El valor debe ser una zona horaria válida",
			"it": "Il valore deve essere un fuso orario valido",
			"de": "Wert muss eine gültige Zeitzone sein",
		},
		msgValidPattern: {
			"en": msgValidPattern,
		...
		msgValidMAC: {
			"en": msgValidMAC,
			"fr": "La valeur de la chaîne doit être une adresse MAC valide",
			"es": "El valor de cadena debe ser una dirección MAC válida",
			"it": "Il valore della stringa deve essere un indirizzo MAC valido",
			"de": "String-Wert muss eine gültige MAC-Adresse sein",
		},
		msgValidCIDR: {
			"en": msgValidCIDR,
			"fr": "La valeur de chaîne doit être une adresse CIDR valide",
			"es": "El valor de cadena debe ser una dirección CIDR válida",
			"it": "Il valore della stringa deve essere un indirizzo CIDR valido",
			"de": "String-Wert muss eine gültige CIDR-Adresse sein",
		},
		msgValidCIDRv4: {
			"en": msgValidCIDRv4,
			"fr": "La valeur de chaîne doit être une adresse CIDR (version 4) valide",
			"es": "El valor de cadena debe ser una dirección CIDR (versión 4) válida",
			"it": "Il valore della stringa deve essere un indirizzo CIDR (versione 4) valido",
			"de": "String-Wert muss eine gültige CIDR-Adresse (Version 4) sein",
		},
		msgValidCIDRv6: {
			"en": msgValidCIDRv6,
			"fr": "La valeur de chaîne doit être une adresse CIDR (version 6) valide",
			"es": "El valor de cadena debe ser una dirección CIDR (versión 6) válida",
			"it": "Il valore della stringa deve essere un indirizzo CIDR (versione 6) valido",
			"de": "String-Wert muss eine gültige CIDR-Adresse (Version 6) sein",
		},
		msgValidIP: {
			"en": msgValidIP,
			"fr": "La chaîne doit être une adresse IP valide",
			"es": "La cadena debe ser una dirección IP válida",
			"it": "La stringa deve essere un indirizzo IP valido",
			"de": "String muss eine gültige IP-Adresse sein",
		},
		msgValidIPv4: {
			"en": msgValidIPv4,
			"fr": "La chaîne doit être une adresse IP valide (version 4)",
			"es": "La cadena debe ser una dirección IP válida (versión 4)",
			"it": "La stringa deve essere un indirizzo IP (versione 4) valido",
			"de": "String muss eine gültige IP-Adresse (Version 4) sein",
		},
		msgValidIPv6: {
			"en": msgValidIPv6,
			"fr": "La chaîne doit être une adresse IP valide (version 6)",
			"es": "La cadena debe ser una dirección IP válida (versión 6)",
			"it": "La stringa deve essere un indirizzo IP (versione 6) valido",
			"de": "String muss eine gültige IP-Adresse (Version 6) sein",
		},
		msgValidTCP: {
			"en": msgValidTCP,
			"fr": "La chaîne doit être une adresse TCP valide",
			"es": "La cadena debe ser una dirección TCP válida",
			"it": "La stringa deve essere un indirizzo TCP valido",
			"de": "String muss eine gültige TCP-Adresse sein",
		},
		msgValidTCPv4: {
			"en": msgValidTCPv4,
			"fr": "La chaîne doit être une adresse TCP (version 4) valide",
			"es": "La cadena debe ser una dirección TCP válida (versión 4)",
			"it": "La stringa deve essere un indirizzo TCP (versione 4) valido",
			"de": "String muss eine gültige TCP-Adresse (Version 4) sein",
		},
		msgValidTCPv6: {
			"en": msgValidTCPv6,
			"fr": "La chaîne doit être une adresse TCP (version 6) valide",
			"es": "La cadena debe ser una dirección TCP válida (versión 6)",
			"it": "La stringa deve essere un indirizzo TCP (versione 6) valido",
			"de": "String muss eine gültige TCP-Adresse (Version 6) sein",
		},
		msgValidUDP: {
			"en": msgValidUDP,
			"fr": "La chaîne doit être une adresse UDP valide",
			"es": "La cadena debe ser una dirección UDP válida",
			"it": "La stringa deve essere un indirizzo UDP valido",
			"de": "String muss eine gültige UDP-Adresse sein",
		},
		msgValidUDPv4: {
			"en": msgValidUDPv4,
			"fr": "La chaîne doit être une adresse UDP (version 4) valide",
			"es": "La cadena debe ser una dirección UDP (versión 4) válida",
			"it": "La stringa deve essere un indirizzo UDP (versione 4) valido",
			"de": "String muss eine gültige UDP-Adresse (Version 4) sein",
		},
		msgValidUDPv6: {
			"en": msgValidUDPv6,
			"fr": "La chaîne doit être une adresse UDP (version 6) valide",
			"es": "La cadena debe ser una dirección UDP (versión 6) válida",
			"it": "La stringa deve essere un indirizzo UDP (versione 6) valido",
			"de": "String muss eine gültige UDP-Adresse (Version 6) sein",
		},
		msgValidTld: {
			"en": msgValidTld,
			"fr": "La chaîne doit être un TLD valide",
			"es": "La cadena debe ser un TLD válido",
			"it": "La stringa deve essere un TLD valido",
			"de": "String muss eine gültige TLD sein",
		},
	},
	Formats: map[string]map[string]string{
		...
		fmtMsgStringContains: {
			"en": fmtMsgStringContains,
			"fr": "La chaîne doit contenir %[1]s",
			"es": "La cadena debe contener %[1]s",
			"it": "La stringa deve contenere %[1]s",
			"de": "Zeichenfolge muss %[1]s enthalten",
		},
		fmtMsgStringNotContains: {
			"en": fmtMsgStringNotContains,
			"fr": "La chaîne ne doit pas contenir %[1]s",
			"es": "La cadena no debe contener %[1]s",
			"it": "La stringa non deve contenere %[1]s",
			"de": "Zeichenfolge darf %[1]s nicht enthalten",
		},
		fmtMsgStringStartsWith: {
			"en": fmtMsgStringStartsWith,
			"fr": "La valeur de chaîne doit commencer par %[1]s",
			"es": "El valor de cadena debe comenzar con %[1]s",
			"it": "Il valore della stringa deve iniziare con %[1]s",
			"de": "Zeichenfolgenwert muss mit %[1]s beginnen",
		},
		fmtMsgStringNotStartsWith: {
			"en": fmtMsgStringNotStartsWith,
			"fr": "La valeur de chaîne ne doit pas commencer par %[1]s",
			"es": "El valor de cadena no debe comenzar con %[1]s",
			"it": "Il valore della stringa non deve iniziare con %[1]s",
			"de": "Zeichenfolgenwert darf nicht mit %[1]s beginnen",
		},
		fmtMsgStringEndsWith: {
			"en": fmtMsgStringEndsWith,
			"fr": "La valeur de chaîne doit se terminer par %[1]s",
			"es": "El valor de cadena debe terminar con %[1]s",
			"it": "Il valore della stringa deve terminare con %[1]s",
			"de": "Zeichenfolgenwert muss mit %[1]s enden",
		},
		fmtMsgStringNotEndsWith: {
			"en": fmtMsgStringNotEndsWith,
			"fr": "La valeur de chaîne ne doit pas se terminer par %[1]s",
			"es": "El valor de cadena no debe terminar con %[1]s",
			"it": "Il valore della stringa non deve terminare con %[1]s",
			"de": "Zeichenfolgenwert darf nicht mit %[1]s enden",
		},
	},
}
